...
def discover_openS3_content(endpoint=None, access_key=None, secret_key=None, output_path=None, reload_catalog=True):
    """
...
def main():
    ...
    if success:
        ...
        if reload_success:
            ...
            print("⚠️ Failed to reload OpenAthena catalog. Manual reload may be required.")
            print("💡 Tip: Try restarting the OpenAthena server or using the GUI reload button")
    else:
