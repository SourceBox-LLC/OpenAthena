...
def configure_httpfs_headers_auth(
    ...
    try:
        ...
        print(f"✅ Environment variables set: OPENS3_ACCESS_KEY={username}, OPENS3_ENDPOINT={endpoint_with_protocol}")
...
def get_opens3_credentials():
    ...
    print(f"Debug: OPENS3_ACCESS_KEY = {'Set' if os.environ.get('OPENS3_ACCESS_KEY') else 'Not set'}")
    print(f"Debug: OPENS3_SECRET_KEY = {'Set' if os.environ.get('OPENS3_SECRET_KEY') else 'Not set'}")
    ...
    username = (os.environ.get("OPENS3_USER") or 
               os.environ.get("OPENS3_ACCESS_KEY") or
               os.environ.get("S3_USER") or 
               os.environ.get("S3_ACCESS_KEY_ID"))
    
    # For password/secret_key
    password = (os.environ.get("OPENS3_PASSWORD") or 
               os.environ.get("OPENS3_SECRET_KEY") or 
               os.environ.get("S3_PASSWORD") or 
               os.environ.get("S3_SECRET_ACCESS_KEY") or 
               "password")
