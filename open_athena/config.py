...
class Config:
    ...
    def _override_from_env(self) -> None:
        ...
        if os.environ.get('OPENATHENA_CATALOG_PATH'):
            self.config_data['database']['catalog_path'] = os.environ.get('OPENATHENA_CATALOG_PATH')
        
        if os.environ.get('OPENATHENA_THREADS'):
            self.config_data['database']['threads'] = int(os.environ.get('OPENATHENA_THREADS'))
        
        if os.environ.get('OPENATHENA_MEMORY_LIMIT'):
            self.config_data['database']['memory_limit'] = os.environ.get('OPENATHENA_MEMORY_LIMIT')
        
        if os.environ.get('OPENATHENA_ENABLE_CACHING'):
            self.config_data['database']['enable_caching'] = os.environ.get('OPENATHENA_ENABLE_CACHING').lower() == 'true'
