...
def configure_s3_for_opens3():
    ...
    endpoint = os.environ.get("S3_ENDPOINT") or os.environ.get("OPENS3_ENDPOINT", "localhost:8001")
    username = os.environ.get("OPENS3_USER") or os.environ.get("S3_USER") or "admin"
    password = os.environ.get("AWS_SECRET_ACCESS_KEY") or os.environ.get("OPENS3_SECRET_KEY", "password")
    access_key = os.environ.get("AWS_ACCESS_KEY_ID") or os.environ.get("OPENS3_ACCESS_KEY", "admin")
