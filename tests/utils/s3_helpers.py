...
def get_s3_credentials() -> Tuple[Optional[str], Optional[str], Optional[str]]:
    ...
    access_key = os.environ.get("OPENS3_ACCESS_KEY") or os.environ.get(
        "AWS_ACCESS_KEY_ID"
    )
    secret_key = os.environ.get("OPENS3_SECRET_KEY") or os.environ.get(
...
def download_file(
    endpoint: str, access_key: str, secret_key: str, bucket: str, file_key: str
